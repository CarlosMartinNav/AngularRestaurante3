...
export class MenuComponent implements OnInit {
  ...
  menu: Menu = {
    recomendacion_chef: [
      { nombre: "Langosta", descripcion: "Langosta a la parrilla con salsa de mantequilla y vegetales de temporada.", precio: 25, alergenos: ["Mariscos"], imagen: "img/Langosta.webp" },
      { nombre: "Filete Wagyu", descripcion: "Reducción de vino tinto, acompañado de puré de papas con trufa y espárragos asados.", precio: 45, alergenos: ["Lácteos", "Gluten"], imagen: "img/Carne Wagyu con Reducción de Vino Tinto.webp" },
      { nombre: "Millé-feuille", descripcion: "Capas de hojaldre crujiente, crema de vainilla y fresas frescas.", precio: 12, alergenos: ["Gluten", "Lácteos"], imagen: "img/postreTartaFresas.webp" }
    ],
    ...
    cafes: [
    { nombre: "Cappuccino de granos Árabes", descripcion: "Espresso de granos arábica seleccionados, leche vaporizada de textura sedosa.", precio: 5, alergenos: ["Lácteos"], imagen: "img/cafe1.webp" },
    { nombre: "Matcha", descripcion: "Matcha latte preparado con té verde japonés de alta calidad.", precio: 6, alergenos: ["Lácteos"], imagen: "img/matcha.webp" },
    { nombre: "Té", descripcion: "Té dorado con toques de limón, canela y menta fresca.", precio: 4, alergenos: [], imagen: "img/postreTe.webp" }
  ],
    ...
    cocteles: [
    { nombre: "Cosmopolitan", descripcion: "Cosmopolitan de color rosa vibrante, servido en una copa de martini con detalles dorados.", precio: 12, alergenos: [], imagen: "img/Cosmopolitan.webp" },
    { nombre: "Gin Tonic", descripcion: "Gin tonic servido con rodajas de pepino, ruedas de lima y menta.", precio: 10, alergenos: [], imagen: "img/ginTonic.jpg" },
    { nombre: "Whisky", descripcion: "Old Fashioned clásico con base de whisky, servido en un vaso con borde dorado.", precio: 15, alergenos: [], imagen: "img/Whisky.webp" },
    { nombre: "Martini de Naranja con Romero", descripcion: "Martini con naranja y un toque de romero.", precio: 14, alergenos: [], imagen: "img/MartiniNaranja.webp" },
    { nombre: "Cóctel de Frambuesa y Menta", descripcion: "Cóctel rojo profundo, decorado con frambuesas y menta.", precio: 13, alergenos: [], imagen: "img/coctelFrambuesa.webp" },
    { nombre: "Cóctel Verde con Pepino y Lima", descripcion: "Cóctel refrescante con pepino, lima y flores comestibles.", precio: 12, alergenos: [], imagen: "img/coctelVerdePepino.webp" }
  ]
  };
